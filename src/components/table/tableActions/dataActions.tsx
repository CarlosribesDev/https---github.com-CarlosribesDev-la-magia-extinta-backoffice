            ...
            <section className="flex items-center mb-4 sm:mb-0">
                <form className="sm:pr-3">
                    <div className="relative w-48 mt-1 sm:w-64 xl:w-96">
                        <input className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 block w-full p-2.5" placeholder={`Buscar ${modelName}`} />
                    </div>
                </form>
            </section>
